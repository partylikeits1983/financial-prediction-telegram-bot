...
df = pd.read_json('https://api.binance.com/api/v3/klines?symbol=BTCUSDT&interval=1d&limit=1000')
...
# Amazon stock market
ticker = "BTC"
ticker_data_filename = os.path.join("dataBTC", f"{ticker}_{date_now}.csv")
...
def plot_graph(test_df):
    ...
    plt.show()
    fig.savefig('/home/ubuntu/Desktop/TelegramBot/charts/BTCml.jpeg', dpi=400, bbox_inches='tight')
...
model_path = os.path.join("/home/ubuntu/Desktop/TelegramBot/tensorflow/tensorflowdata/resultsBTC", model_name) + ".h5"
...
b = "{}".format(a)
file = open('/home/ubuntu/Desktop/TelegramBot/predictions/buyprofitBTC.txt', 'w')
file.write(b)
file.close()

a = str(round(total_sell_profit, 2))
b = "{}".format(a)
file = open('/home/ubuntu/Desktop/TelegramBot/predictions/sellprofitBTC.txt', 'w')
file.write(b)
file.close()

a = str(round(total_profit, 2))
b = "{}".format(a)
file = open('/home/ubuntu/Desktop/TelegramBot/predictions/totalprofitBTC.txt', 'w')
file.write(b)
file.close()

a = str(round(profit_per_trade, 2))
b = "{}".format(a)
file = open('/home/ubuntu/Desktop/TelegramBot/predictions/profitpertradeBTC.txt', 'w')
file.write(b)
file.close()
