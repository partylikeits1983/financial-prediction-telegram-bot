...
df = pd.read_json('https://api.binance.com/api/v3/klines?symbol=ETHUSDT&interval=1d&limit=1000')
...
def plot_graph(test_df):
    ...
    plt.show()
    fig.savefig('/home/ubuntu/Desktop/TelegramBot/charts/ETHml.jpeg', dpi=400, bbox_inches='tight')
...
model_path = os.path.join("/home/ubuntu/Desktop/TelegramBot/tensorflow/tensorflowdata/resultsETH", model_name) + ".h5"
...
b = "{}".format(a)
file = open('/home/ubuntu/Desktop/TelegramBot/predictions/buyprofitETH.txt', 'w')
file.write(b)
file.close()

a = str(round(total_sell_profit, 2))
b = "{}".format(a)
file = open('/home/ubuntu/Desktop/TelegramBot/predictions/sellprofitETH.txt', 'w')
file.write(b)
file.close()

a = str(round(total_profit, 2))
b = "{}".format(a)
file = open('/home/ubuntu/Desktop/TelegramBot/predictions/totalprofitETH.txt', 'w')
file.write(b)
file.close()

a = str(round(profit_per_trade, 2))
b = "{}".format(a)
file = open('/home/ubuntu/Desktop/TelegramBot/predictions/profitpertradeETH.txt', 'w')
file.write(b)
file.close()
