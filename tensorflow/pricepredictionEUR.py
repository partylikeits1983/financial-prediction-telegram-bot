...
def plot_graph(test_df):
    ...
    plt.show()
    fig.savefig('/home/ubuntu/Desktop/TelegramBot/charts/EURml.jpeg', dpi=400, bbox_inches='tight')
...
model_path = os.path.join("/home/ubuntu/Desktop/TelegramBot/tensorflow/tensorflowdata/resultsEUR", model_name) + ".h5"
...
b = "{}".format(a)
file = open('/home/ubuntu/Desktop/TelegramBot/predictions/buyprofitEUR.txt', 'w')
file.write(b)
file.close()

a = str(round(total_sell_profit, 2))
b = "{}".format(a)
file = open('/home/ubuntu/Desktop/TelegramBot/predictions/sellprofitEUR.txt', 'w')
file.write(b)
file.close()

a = str(round(total_profit, 2))
b = "{}".format(a)
file = open('/home/ubuntu/Desktop/TelegramBot/predictions/totalprofitEUR.txt', 'w')
file.write(b)
file.close()

a = str(round(profit_per_trade, 2))
b = "{}".format(a)
file = open('/home/ubuntu/Desktop/TelegramBot/predictions/profitpertradeEUR.txt', 'w')
file.write(b)
file.close()
