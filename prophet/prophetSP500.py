...
graph = data.DataReader("^GSPC", "yahoo", start, end)
...
forcast.savefig('/home/ubuntu/Desktop/TelegramBot/charts/SP500forcast.jpeg', dpi=400, bbox_inches='tight')


trend = m0.plot_components(forecast);
trend.savefig('/home/ubuntu/Desktop/TelegramBot/charts/SP500trend.jpeg', dpi=400, bbox_inches='tight')
