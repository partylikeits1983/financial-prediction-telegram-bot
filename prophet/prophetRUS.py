...
graph = data.DataReader("^RUT", "yahoo", start, end)
...
forcast.savefig('/home/ubuntu/Desktop/TelegramBot/charts/RUSforcast.jpeg', dpi=400, bbox_inches='tight')


trend = m0.plot_components(forecast);
trend.savefig('/home/ubuntu/Desktop/TelegramBot/charts/RUStrend.jpeg', dpi=400, bbox_inches='tight')
