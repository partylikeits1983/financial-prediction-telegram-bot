...
graph = data.DataReader("XMR-USD", "yahoo", start, end)
...
forcast.savefig('/home/ubuntu/Desktop/TelegramBot/charts/XMRforcast.jpeg', dpi=400, bbox_inches='tight')


trend = m0.plot_components(forecast);
trend.savefig('/home/ubuntu/Desktop/TelegramBot/charts/XMRtrend.jpeg', dpi=400, bbox_inches='tight')
