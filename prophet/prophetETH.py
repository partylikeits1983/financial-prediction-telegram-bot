...
graph = data.DataReader("ETH-USD", "yahoo", start, end)
...
forcast.savefig('/home/ubuntu/Desktop/TelegramBot/charts/ETHforcast.jpeg', dpi=400, bbox_inches='tight')


trend = m0.plot_components(forecast);
trend.savefig('/home/ubuntu/Desktop/TelegramBot/charts/ETHtrend.jpeg', dpi=400, bbox_inches='tight')
