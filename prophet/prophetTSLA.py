...
graph = data.DataReader("TSLA", "yahoo", start, end)
...
forcast.savefig('/home/ubuntu/Desktop/TelegramBot/charts/TSLAforcast.jpeg', dpi=400, bbox_inches='tight')


trend = m0.plot_components(forecast);
trend.savefig('/home/ubuntu/Desktop/TelegramBot/charts/TSLAtrend.jpeg', dpi=400, bbox_inches='tight')
