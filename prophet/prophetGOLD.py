...
graph = data.DataReader("GC=F", "yahoo", start, end)
...
forcast.savefig('/home/ubuntu/Desktop/TelegramBot/charts/GOLDforcast.jpeg', dpi=400, bbox_inches='tight')


trend = m0.plot_components(forecast);


trend.savefig('/home/ubuntu/Desktop/TelegramBot/charts/GOLDtrend.jpeg', dpi=400, bbox_inches='tight')
